...
func (uu *UserUpdate) SetBody(s string) *UserUpdate {
	uu.mutation.SetBody(s)
	return uu
}
...
func (uu *UserUpdate) check() error {
	...
	if v, ok := uu.mutation.Body(); ok {
		if err := user.BodyValidator(v); err != nil {
			return &ValidationError{Name: "body", err: fmt.Errorf(`ent: validator failed for field "User.body": %w`, err)}
		}
	}
	return nil
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Body(); ok {
		_spec.SetField(user.FieldBody, field.TypeString, value)
	}
...
// SetBody sets the "body" field.
func (uuo *UserUpdateOne) SetBody(s string) *UserUpdateOne {
	uuo.mutation.SetBody(s)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Body(); ok {
		_spec.SetField(user.FieldBody, field.TypeString, value)
	}
